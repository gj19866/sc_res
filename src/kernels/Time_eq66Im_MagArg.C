#include "Time_eq66Im_MagArg.h"
#include <cmath>

registerMooseObject("SCResApp", Time_eq66Im_MagArg);

InputParameters
Time_eq66Im_MagArg::validParams()
{
...
Time_eq66Im_MagArg::Time_eq66Im_MagArg(const InputParameters & parameters)
...
ADReal
Time_eq66Im_MagArg::computeQpResidual()
{
  ...
  ADReal total = part1 + part2 + part3 + part4 + part5;
